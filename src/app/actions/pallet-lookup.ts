    ...
    if (receptionItem) {
        return {
            ...
            palletInfo: {
                ...
                pesoBruto: receptionItem.pesoBruto,
                taraEstiba: receptionItem.taraEstiba,
                taraCaja: receptionItem.taraCaja,
                totalTaraCaja: receptionItem.totalTaraCaja,
                pesoNeto: receptionItem.pesoNeto,
            }
        };
    }
