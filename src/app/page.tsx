...
import { FileText, LogOut, Users2, Box, ScrollText, BookCopy, ShieldCheck, Settings, Timer, ArrowRight, ArrowDownCircle, ArrowUpCircle, Boxes, ClipboardList, Users, TrendingUp, DollarSign, ListTodo } from 'lucide-react';
...
export default function Home() {
  ...
  const menuItems: { label: string; href: string; icon: React.FC<any>; permission: keyof AppPermissions }[] = [
    ...
    { label: 'Indicadores y Liquidación Cuadrilla', href: '/crew-performance-report', icon: TrendingUp, permission: 'canViewCrewPerformanceReport' },
