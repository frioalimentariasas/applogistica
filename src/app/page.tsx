...
import { FileText, LogOut, Users2, Box, ScrollText, BookCopy, ShieldCheck, Settings, Timer, ArrowRight, ArrowDownCircle, ArrowUpCircle, Boxes, ClipboardList, Users, TrendingUp as TrendingUpIcon } from 'lucide-react';
...
export default function Home() {
  ...
  const menuItems: { label: string; href: string; icon: React.FC<any>; permission: keyof AppPermissions }[] = [
    ...
    { label: 'Gestión de Estándares de Productividad', href: '/gestion-estandares', icon: TrendingUpIcon, permission: 'canManageStandards' },
