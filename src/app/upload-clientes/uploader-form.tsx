...
import { uploadClientes } from './actions';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import { ArrowLeft, Loader2, Users2, FileUp } from 'lucide-react';
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Elija el archivo Excel que desea importar. El sistema lo procesará y cargará los datos a la colección "clientes" en su base de datos de Firestore.</CardDescription>
                    </CardHeader>
                    <CardContent>
