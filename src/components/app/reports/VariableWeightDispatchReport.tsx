        ...
        <>
            <ReportSection title="Datos del Despacho">
                <div className="grid grid-cols-3 gap-x-4 gap-y-1">
                    ...
                    <ReportField label="Hora Inicio Cargue" value={formData.horaInicio} />

                    <ReportField label="Hora Fin Cargue" value={formData.horaFin} />
                </div>
            </ReportSection>
                ...
                <table className="w-full text-xs border-collapse">
                    <thead>
                        <tr className="border-b border-gray-400">
                            ...
                            <th className="text-left p-1 font-bold">Presentación</th>
                            <th className="text-right p-1 font-bold">Cant.</th>
                            <th className="text-right p-1 font-bold">Peso Neto (kg)</th>
                        </tr>
                    </thead>
                    <tbody>
                        {formData.items.map((p: any, i: number) => (
                            <tr key={i} className="border-b border-gray-300">
                                ...
                                <td className="p-1">{p.presentacion}</td>
